...
from core.common.constants import RELEASED_PARAM, VERBOSE_PARAM, INCLUDE_RETIRED_PARAM, PROCESSING_PARAM, \
    ...
    INCLUDE_MAPPINGS_PARAM, CASCADE_LEVELS_PARAM, CASCADE_DIRECTION_PARAM, CASCADE_ALL_VERSIONS
# HEADERS
...
cascade_all_versions = openapi.Parameter(
    CASCADE_ALL_VERSIONS, openapi.IN_QUERY, type=openapi.TYPE_BOOLEAN, default=False
)
