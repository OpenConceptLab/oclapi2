...
class Concept(ConceptValidationMixin, SourceChildMixin, VersionedModel):  # pylint: disable=too-many-public-methods
    ...
    es_fields = {
        ...
        'concept_class': {'sortable': True, 'filterable': True, 'facet': True, 'exact': False, 'facet_field': 'concept_class_text.keyword'},
        'datatype': {'sortable': True, 'filterable': True, 'facet': True, 'exact': False, 'facet_field': 'datatype_text.keyword'},
        ...
        'source': {'sortable': True, 'filterable': True, 'facet': True, 'exact': False, 'facet_field': 'source_text.keyword'},
        ...
        'owner': {'sortable': True, 'filterable': True, 'facet': True, 'exact': False, 'facet_field': 'owner_text.keyword'},
