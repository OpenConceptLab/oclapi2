...
from core.common.swagger_parameters import (
    ...
    include_mappings_param, cascade_levels_param, cascade_direction_param, cascade_view_hierarchy, cascade_all_versions)
...
class ConceptCascadeView(ConceptBaseView):
    ...
    @swagger_auto_schema(
        manual_parameters=[
            ...
            cascade_direction_param, cascade_view_hierarchy, cascade_all_versions
        ]
    )
