...
CANNOT_SPECIFY_BOTH_TO_CONCEPT_OR_TO_SOURCE = "Must specify either 'to_concept' or 'to_source' & 'to_concept_code'."
MUST_SPECIFY_EITHER_TO_CONCEPT_OR_TO_SOURCE = CANNOT_SPECIFY_BOTH_TO_CONCEPT_OR_TO_SOURCE + " Cannot specify both."
