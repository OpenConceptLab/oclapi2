...
class MappingBaseView(SourceChildCommonBaseView):
    ...
    es_fields = {
        ...
        'from_concept': {'sortable': False, 'filterable': True, 'facet': False},
        'to_concept': {'sortable': False, 'filterable': True, 'facet': False},
        'retired': {'sortable': False, 'filterable': True, 'facet': True},
        'map_type': {'sortable': False, 'filterable': True, 'facet': True},
        ...
        'concept_source': {'sortable': False, 'filterable': True, 'facet': True},
        'from_concept_source': {'sortable': False, 'filterable': True, 'facet': True},
        'to_concept_source': {'sortable': False, 'filterable': True, 'facet': True},
        'concept_owner': {'sortable': False, 'filterable': True, 'facet': True},
        'from_concept_owner': {'sortable': False, 'filterable': True, 'facet': True},
        'to_concept_owner': {'sortable': False, 'filterable': True, 'facet': True},
