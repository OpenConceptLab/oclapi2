...
class ConceptsFromSourceQueryTests(OCLTestCase):
    ...
    def setUp(self):
        # This suite exercises ORM hydration/fallback; index projections have independent tests.
        projection = mock.patch('core.graphql.queries.indexed_concepts', return_value=None)
        projection.start()
